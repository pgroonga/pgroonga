...
PGRN_FUNCTION_INFO_V1(pgroonga_match_text_condition_with_scorers);
...
PGRN_FUNCTION_INFO_V1(pgroonga_match_varchar_condition_with_scorers);
...
PGRN_FUNCTION_INFO_V1(pgroonga_query_text_condition_with_scorers);
